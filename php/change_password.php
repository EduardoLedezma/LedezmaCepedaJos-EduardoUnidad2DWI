...
if (!isset($_SESSION['user_id'])) {
    mostrarAlerta('warning', 'Acceso denegado', 'Debes iniciar sesión para cambiar tu contraseña.', '/pages/login.html');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        mostrarAlerta('success', '¡Listo!', 'Contraseña actualizada exitosamente.', '/index.php');
