...
include __DIR__ .  '/php/navbar_index.php';
?>
...
<div id="carouselFotos" class="carousel slide mt-4 carrusel-ajustado" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img/carrusel1.jpg" class="d-block w-100" alt="Instrumento 1">
    </div>
    <div class="carousel-item">
      <img src="/img/carrusel2.jpg" class="d-block w-100" alt="Instrumento 2">
    </div>
    <div class="carousel-item">
      <img src="/img/carrusel3.jpg" class="d-block w-100" alt="Instrumento 3">
    </div>
  </div>
      ...
      <div class="card bg-dark text-white h-100">
        <div class="card-body">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="/pages/login.php" class="text-white text-decoration-none">🔐 Iniciar sesión</a></li>
            <li><a href="/pages/register.php" class="text-white text-decoration-none">📝 Registrarse</a></li>
