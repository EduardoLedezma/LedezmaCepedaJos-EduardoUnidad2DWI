...
<div class="container-form mt-5">
  ...
  <form action="/Practica-Gabriel-Unidad3/php/recover.php" method="POST" onsubmit="return validarRecuperacion();">
    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (params.has('exito')) {
    Swal.fire({
      ...
      window.location.href = '/Practica-Gabriel-Unidad3/index.php';
    });
  }
});
</script>
